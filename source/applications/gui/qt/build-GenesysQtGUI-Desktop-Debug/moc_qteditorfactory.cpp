...
#include <memory>
#include "../GenesysQtGUI/QPropertyBrowser/qteditorfactory.h"
...
QT_MOC_LITERAL(6, 89, 12), // "slotSetValue"
QT_MOC_LITERAL(7, 102, 19) // "slotEditorDestroyed"
...
QT_MOC_LITERAL(5, 69, 12), // "slotSetValue"
QT_MOC_LITERAL(6, 82, 19) // "slotEditorDestroyed"
...
void QtLineEditFactory::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->d_func()->slotSetValue((*reinterpret_cast< const QString(*)>(_a[1]))); break;
