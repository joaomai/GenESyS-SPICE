...
#include <memory>
#include "../GenesysQtGUI/dialogs/dialogpluginmanager.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_DialogPluginManager_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_DialogPluginManager_t qt_meta_stringdata_DialogPluginManager = {
    {
QT_MOC_LITERAL(0, 0, 19) // "DialogPluginManager"
...
static const uint qt_meta_data_DialogPluginManager[] = {
...
QT_INIT_METAOBJECT const QMetaObject DialogPluginManager::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_DialogPluginManager.data,
