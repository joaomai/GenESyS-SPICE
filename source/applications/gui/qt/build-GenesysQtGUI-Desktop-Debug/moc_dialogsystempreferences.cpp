...
#include <memory>
#include "../GenesysQtGUI/dialogs/dialogsystempreferences.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_DialogSystemPreferences_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_DialogSystemPreferences_t qt_meta_stringdata_DialogSystemPreferences = {
    {
QT_MOC_LITERAL(0, 0, 23) // "DialogSystemPreferences"
...
static const uint qt_meta_data_DialogSystemPreferences[] = {
...
QT_INIT_METAOBJECT const QMetaObject DialogSystemPreferences::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_DialogSystemPreferences.data,
